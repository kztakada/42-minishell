...
// grammar_redirect.c
int			grammar_heredoc(t_list **follower_list);
int			grammar_re_append(t_list **follower_list);
int			grammar_re_input(t_list **follower_list);
int			grammar_re_output(t_list **follower_list);
...
int			grammar_operand_text(t_token *testing_token,
